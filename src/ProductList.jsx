...
function ProductList({ onHomeClick }) {
    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                { name: "ZZ Plant", image: "https://images.unsplash.com/photo-163220_FIFO9-b96d1e63d14b?q=80&w=464&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Thrives in low light and requires minimal watering.", cost: "$25" },
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <div style={{ textDecoration: 'none', cursor: 'pointer' }} onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white', margin: 0 }}>Paradise Nursery</h3>
                                <i style={{ color: 'white', fontStyle: 'italic' }}>Where Green Meets Serenity</i>
                            </div>
                        </div>
                    </div>
                </div>
